...
export default function Users({ setEditUser, setMarkedUser, markedUser, editUser }: UsersProps) {
    ...
    <div className="users-container">
      ...
      <div className="users-map">
        {filteredUsers.map((user) => (
          <User key={user.id} user={user} setEditUser={setEditUser} setMarkedUser={setMarkedUser} />
        ))}
      </div>
    </div>
  )
